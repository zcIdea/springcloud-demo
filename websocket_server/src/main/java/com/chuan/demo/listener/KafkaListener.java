...
public class KafkaListener {
    ...
    @org.springframework.kafka.annotation.KafkaListener(id = "demo", topics = "topic.quick.demo")
    ...
    @org.springframework.kafka.annotation.KafkaListener(id = "default", topics = "topic.quick.default")
